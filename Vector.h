...
public:
    ...
    float distance_sqr(const Vector2& o) {
...
public:
    ...
    float distance_sqr(const Vector3& o) {
...
public:
    ...
    float distance_sqr(const Vector4& o) {
