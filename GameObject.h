...
public:
	...
	bool                  IsEnemyTo(const std::shared_ptr<GameObject> other) const;
	bool                  IsAllyTo(const std::shared_ptr<GameObject> other) const;
	bool                  IsEqualTo(const std::shared_ptr<GameObject> other) const;
	bool                  IsNotEqualTo(const std::shared_ptr<GameObject> other) const;
...
public:			     	 
    ...
    std::list<Vector3>    posLst;
    high_resolution_clock::time_point timePosLst;
...
private:		         
	...
	static BYTE           buffListBuffer[0x100];
